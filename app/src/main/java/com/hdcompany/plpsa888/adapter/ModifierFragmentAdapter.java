...
/* FEATURE ADAPTER */
public class ModifierFragmentAdapter extends RecyclerView.Adapter<ModifierFragmentAdapter.FeatureViewHolder>{
    ...
    /* KHỞI TẠO */
    public ModifierFragmentAdapter(List<Feature> featureList, IManagerFeatureListener iManagerFeatureListener) {
