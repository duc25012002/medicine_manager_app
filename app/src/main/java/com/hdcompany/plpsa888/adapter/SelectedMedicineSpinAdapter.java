...
public class SelectedMedicineSpinAdapter extends ArrayAdapter<Medicine> {
    private final Context context;

    public SelectedMedicineSpinAdapter(@NonNull Context context, int layoutItem, @NonNull List<Medicine> medicineList) {
        super(context, layoutItem, medicineList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if (convertView == null) {
            ...
            tvSelected.setText(this.getItem(position).getMedicineName());
        }
        return convertView;
    }
    ...
    public View getDropDownView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        tvName.setText(this.getItem(position).getMedicineName());
        return view;
    }
